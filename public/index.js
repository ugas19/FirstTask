						...
						<div class="content_2">
							<div id="carouselExampleIndicators" class="carousel slide" style=" width:100%; height: 100%">
								...
								<div class="w3-content" style="max-width:100%; height:79.3%">
										<img class="mySlides w3-animate-right" src="background-front.png" style="width:100%; height:100%">
										<img class="mySlides w3-animate-right" src="house_2.jpg" style="width:100%; height:100%">
										<img class="mySlides w3-animate-right" src="house_3.jpg" style="width:100%; height:100%">
										<img class="mySlides w3-animate-right" src="house_2.jpg" style="width:100%; height:100%">
									  </div>
									  <div class="text_box">
										<div class="text_box_logo">
												<img src="text_box_logo.png" alt="Third slide">
										</div>
